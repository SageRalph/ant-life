...
class Worldlogic {
    ...
    switch (this.world.getTile(x, y)) {
      ...
      case "PLANT":
        ...
        if (
          ...
          return (
            this.world.setTile(x, y + bias2, "PLANT", growMask) ||
            this.world.setTile(x + bias, y + bias2, "PLANT", growMask)
            // this.world.setTile(x + bias, y, "PLANT", growMask) ||
          );
        }
        return;
      ...
      case "EGG":
        ...
        if (Math.random() <= 0.001) {
          ...
          this.world.setTile(x, y, Math.random() < 0.01 ? "QUEEN" : "ANT");
          this.world.ants++;
          return true;
        }
        return (
  ...
  _antMove(x, y) {
    ...
    return (
      ...
      this.world.swapTiles(x, y, x + dx, y + dy, ANT_WALK_MASK)
    );
  }
  ...
  _pestMove(x, y) {
    ...
    return this.world.swapTiles(x, y, x + dx, y + dy, PEST_WALK_MASK);
  }
